...
is small. In the CLAS-E1DVCS experiment 
(2005), CLAS was upgraded with the addition of an Inner Calorimeter (IC). This 
calorimeter covers completely the polar angles between 5$^{\circ}$ and 15$^{\circ}$. Figure 
\ref{fig:CLAS_RTPC_2} shows a schematic plot of our experimental setup. The front face of the IC is facing the downstream side of 
the Radial TPC (RTPC) and placed at 16 cm from the center of CLAS.\\
