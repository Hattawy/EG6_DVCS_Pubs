...
\bibitem{Vadim_priv}
   Private communications with V.~Guzey based on reference 
   \cite{{EMC_vadim_3}}. 

\bibitem{Guidal_priv}
   Private communications with M.~Guidal based on reference:   M.~Guidal, 
   M.~V.~Polyakov, A.~V.~Radyushkin and M.~Vanderhaeghen, Nucleon form-factors 
   from generalized parton distributions,
     Phys.\ Rev.\ D {\bf 72}, 054013, [hep-ph/0410251], 2005.

\bibitem{GonzalezHernandez:2012jv} Private communications with S.~Liuti based 
   on:  J.~O.~Gonzalez-Hernandez, S.~Liuti, G.~R.~Goldstein and K.~Kathuria,
     Interpretation of the Flavor Dependence of Nucleon Form Factors in a 
     Generalized Parton Distribution Model, Phys.\ Rev.\ C {\bf 88}, no. 6, 
     065206, arXiv:1206.1876 [hep-ph], 2013.
