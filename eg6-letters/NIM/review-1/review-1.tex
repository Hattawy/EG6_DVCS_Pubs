...
\item Relevant length and thicknesses of the various elements are reported in 
   ...
   GEM.\\
\textcolor{red}{- The target tube is the central z-axis of the detector. The 
text is modified to make it clean. Raph: He understands that, he asks what is the z position.\\}
\textcolor{red}{- Regarding the electric field, it was 2.8 kV/cm in BoNuS, does 
anyone know our exact field in this gap? Raph: This is indicated already, I am not sure what he
means by "induction gap"\\}
\textcolor{red}{We did not evaluate precisely the overall gain in our chamber.
Can we quote a value from comparison with Bethe-Heitler or GEANT4?}
...
the simulations?\\
\textcolor{red}{Raph: I will modify the text for this.} 

\item Figure 6: why are $T_{min}$ and $T_{max}$ not at the drift gap 
   extremities?\\
   \textcolor{red}{This is a schematic to illustrate the definitions of 
   $T_{min}$ and $T_{max}$ in a chain of hits. The figure can be modified if 
needed. Raph: Are you asking him if he insists? We need to fix the figure.} 
