...
shows how pads were grouped to 16 channels pre-amplifiers. The pre-amplifier boards, 
...
referred to to the trigger time, the resolution is equivalent to the ALTRO 
...
fields over the whole volume of the detector. We this calculation as a 
