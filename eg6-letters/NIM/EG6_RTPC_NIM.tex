...
%\begin{keywords}
%\textcolor{red}{Raphael please add the list you provided originally},
...
illustrated in Figure~\ref{fig:RTPC_1_4}. The RTPC is segmented into two halves 
with independent GEM amplification systems that cover about 80\% of the 
azimuthal angle.
