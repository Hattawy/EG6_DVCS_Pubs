...
\begin{itemize}
  \item The 6~atm $^4$He target extends from -146~mm to 146~mm in z-direction 
     with respect to the center of the detector forming the detector central 
     axis. It is a 6~mm diameter Kapton straw with a 27~$\mu$m wall.
