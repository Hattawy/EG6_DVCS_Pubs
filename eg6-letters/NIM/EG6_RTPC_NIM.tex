...
\begin{figure}[tbp]
\centering \includegraphics[scale=0.18]{test_clas.png}
...
\begin{figure}[tbp]
\centering
\includegraphics[scale=0.17]{GEM_photo.jpg}
...
\begin{figure}[tb]
   \centering
   \includegraphics[scale=0.21]{PADs.png}
...
\begin{figure}[tb]
   \centering
\includegraphics[scale=0.20]{noisy_pad_before_rejection2.png}
\includegraphics[scale=0.20]{noisy_pad_after_rejection2.png}
