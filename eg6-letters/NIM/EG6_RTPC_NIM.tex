...
figure~\ref{fig:RTPC_1_4}. The CLAS RTPC is segmented into two halves with 
...
\caption{Picture of a typical GEM foil similar to the one used for our RTPC.  
{\color{red} Source?}} \label{fig:GEMs}
\end{figure}
