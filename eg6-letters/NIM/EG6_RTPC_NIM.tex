...
Two different characteristic noise signatures were identified and removed during track reconstruction.  

The first was an oscillatory noise located early in the readout time window in many channels, shown in the top panel of Figure~\ref{fig:noise}.  The amplitude of the noise is not dissimilar to those of real tracks.  About N\% of the channels exhibit this noise signature.  Due to its unique time-energy correlation for a given channel, the noise could be removed on an event by event and channel by channel basis, without any loss of good signals and the result is illustrated in the bottom panel of Figure~\ref{fig:noise}.
