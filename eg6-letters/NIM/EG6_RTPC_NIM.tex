...
The GEM technology has been chosenfor its flexibility as it
...
for the structure to be selfsupporting and only the 
...
scatering ($e^{4}$He$\rightarrow e^{4}$He). In this process, the measurement of
...
The drift paths are ajusted using a set of identified elastic events. We generate 
...
designed to measure helium-4 nuclei in a high rate environnement. The operation
