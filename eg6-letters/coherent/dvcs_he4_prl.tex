...
for a spin-zero hadron can be expressed at leading-order and leading-twist as
\begin{equation}
\begin{split}
&A_{LU}(\phi) = \\
...
where the Convolution-VGG uses nucleon GPDs from the VGG model~\cite{Guidal_priv} 
...
U.S. Department of Energy under contract number DE-AC02-06CH11357, the UK Science and Technology Facilities Council (STFC), the Scottish Universities Physics Alliance (SUPA), the National Research Foundation of Korea, and the Office of Research and Economic 
