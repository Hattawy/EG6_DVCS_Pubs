...
by the BH contribution varying strongly with $\phi$, the azimuthal angle 
between the $(e,e^\prime)$ and $(\gamma^*,^4$He$^\prime)$ planes. The DVCS 
contribution is smaller by about a factor two, but independent of $\phi$ at twist-2~%
\cite{Belitsky:2001ns}, thus it is possible to separate these contributions 
