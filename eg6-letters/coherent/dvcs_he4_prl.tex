...
fiducial region \cite{Hattawy:thesis}. In addition, we apply a vertex-matching cut to ensure that the 
...
cuts is shown in Fig.~\ref{fig:kin-cuts} (see \cite{Hattawy:thesis} for additional details).
...
The distributions from left to right and from top to bottom are: $\Delta 
