...
Lab incident on a pressured $^4$He gaseous target placed in front of the CEBAF large acceptance 
...
important simplification, as spinless hadrons are parametrized by only one 
...
were mainly caused by accidental coincidences of soft photons and did not affect 
...
DVCS, the Bethe-Heitler (BH) process, where the real photon is 
