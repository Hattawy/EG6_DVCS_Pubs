...
target in the center of the CEBAF large acceptance spectrometer. A new radial 
...
$27~\mu$m thick wall. The RTPC was calibrated specifically for the detection of 
$^4$He nuclei using elastic scattering with a 1.2~GeV electron beam.
...
large and for which we reduced the cut window to [-0.45,0.5] GeV).  We also 
...
\begin{figure}[tb]
\includegraphics[width=8cm]{figs/coh_exc_cuts.pdf}
...
the BH and DVCS amplitudes squared and their interference term depend on the
azimuthal angle
...
in \cite{Kirchner:2003wt,Belitsky:2008bz}. Based on this work, the BSA 
...
\cite{Belitsky:2008bz}, they are functions of Fourier harmonics in the 
azimuthal angle $\phi$, the nuclear form factor $F_A(t)$, $Q^2$ and $x_B$,
...
in these factors, it is possible to extract unequivocally both imaginary and real 
...
the three sets of binning is presented. The curves on the plots are fits with 
...
\cite{simonetta_2}. The model takes into account the effect on the quark 
distribution of the virtuality of the nucleon ({\it i.e.} with four-momentum 
squared not equal to the square of their mass). The calculations are at slightly 
...
framework and paves a way for future measurements at JLAB using 12 GeV CEBAF 
