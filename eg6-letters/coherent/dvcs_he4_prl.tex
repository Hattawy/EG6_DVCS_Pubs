...
asymmetry of a spin-zero hadron can be expressed as
\begin{equation}
\begin{split}
&A_{LU}(\phi) = \\
...
The kinematic factors $\alpha_i$ depend on azimuthal angle $\phi$, the nuclear 
form factor $F_A(t)$, $Q^2$ and $x_B$. These factors are written as
\begin{align}
   ...
   \alpha_3 (\phi) &= \frac{x^{2}_{A}t(1+\epsilon^2)^2}{y} {\mathcal P}_1(\phi) 
      ...
      \epsilon^2},
\end{align}
where $x_{A} = \frac{x_{B}M_{N}}{M_{A}}$ with $M_{A}$($M_{N}$) the $^4$He 
(nucleon) mass, $\epsilon = \frac{2x_{A}M_{A}}{\sqrt{Q^{2}}}$ and 
$y=\frac{Q^{2}}{2x_{A}M_{A}E_{beam}}$, and $\mathcal{P}_1(\phi)$ and $\mathcal 
...
\cite{simonetta_2}. The model relies on the impulse approximation and uses 
...
These differences may arise from nuclear effects, such as long-rage 
interactions, which are not taken into account in the model.
