...
asymmetries are larger than that observed on the free proton in the same kinematic 
...
virtual photon's 4-momentum squared, $Q^2=-(k-k')^{2}$, and small squared 
...
can however guaranty that the nucleus remains intact. 
...
4$^{\circ}$. The 5 T solenoid magnet acts as a guiding field for the 
low-energy M\o{}ller electrons, that are absorbed in a  
...
RTPC is a $20$-cm-long cylinder with a diameter of $15$ cm, positioned in the 
solenoid magnet. In the center of the RTPC is the target, a $25$-cm-long 
...
are identified using their measured momentum, light yield, time, and energy obtained from 
...
are identified in the RTPC using time and energy-loss cuts for tracks in the 
...
distributions represent those which passed all the exclusivity cuts except 
...
\caption{The $Q^{2}$ (left), $x_{B}$ (middle), and $t$-dependencies (right) of
   ...
   \cite{Airapetian}, the curves represent the theoretical calculations 
