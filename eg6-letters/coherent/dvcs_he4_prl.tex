...
The $^4$He nucleus is an ideal experimental target for DVCS on nuclei, as it is light enough to be detected in such a setting, while it is subject to significant nuclear effects 
...
The CEBAF large acceptance spectrometer in Hall-B at Jefferson Lab has been
...
parts of $\mathcal{H}_{A}$ by fitting the $A_{LU}(\phi)$ distrubution.
...
2 to 4\%.  Studies of systematic uncertainties showed that the main 
contributions come from the choice of DVCS exclusivity cuts (8\%) and the 
