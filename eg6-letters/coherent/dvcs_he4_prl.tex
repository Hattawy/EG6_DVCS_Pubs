...
Lab incident on a pressurized $^4$He gaseous target in front of the CEBAF Large Acceptance 
...
were caused by accidental coincidences of soft photons and did not directly
...
\label{eq:A_LU-coh}
\end{equation}
where explicit expressions of the kinematic factors $\alpha_i$ are derived in
