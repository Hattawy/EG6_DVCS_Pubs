...
//=========  (Thu May 23 14:35:03 2019) by ROOT version 6.14/04
   ...
   HALU_p_vs_Q2__1->GetYaxis()->SetLabelFont(42);
   ...
   HALU_p_vs_Q2__1->GetYaxis()->SetTitleFont(42);
   ...
   TLegend *leg = new TLegend(0.5,0.76,0.92,0.92,NULL,"brNDC");
   leg->SetBorderSize(1);
   leg->SetLineColor(1);
   leg->SetLineStyle(1);
   leg->SetLineWidth(1);
   ...
   entry=leg->AddEntry("Scope","Fucini et al. [41]","l");
