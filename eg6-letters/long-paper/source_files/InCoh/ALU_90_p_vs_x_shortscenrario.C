...
//   graph->SetLineStyle(7);
   ...
   TLegend *leg = new TLegend(0.44,0.67,0.92,0.92,NULL,"brNDC");
   leg->SetBorderSize(1);
   leg->SetLineColor(1);
   leg->SetLineStyle(1);
   leg->SetLineWidth(1);
   ...
   entry=leg->AddEntry("Graph1","Liuti et al. (low -t) [30,31]","L");
   entry->SetTextFont(42);
   entry=leg->AddEntry("Graph2","Liuti et al. (high -t) [30,31]","L");
   entry->SetTextFont(42);
