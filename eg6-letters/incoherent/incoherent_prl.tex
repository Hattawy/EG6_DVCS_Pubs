...
model predicts an enhancement of the ratio, where our experiment shows a sharp 
drop. This measurement shows that an important nuclear effect is missing from 
the existing models in order to explain this strong quenching of the BSA.
