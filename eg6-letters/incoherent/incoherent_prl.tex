...
from the quark-meson coupling model \cite{Guzey:2008fe}. In particular, the 
difference becomes large at lower $x_B$, where the off-shell model predicts an 
enhancement of the ratio, while our experiment shows no sign of an increase of 
ratios. This measurement shows that an important nuclear effect is missing from 
the existing models in order to explain this strong quenching of the BSA. More 
theoretical developments will be needed to identify the origin of this 
quenching, in particular it will be key to differenciate initial from final 
state effects and how they can affect the DVCS assymetries.
