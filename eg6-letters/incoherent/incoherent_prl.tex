...
used here were accumulated using a $6$ GeV longitudinally polarized electron beam incident on
...
regions of kinematics for which it is not possible to calculate the radiative 
effects. We specifically use the 
...
In the kinematical phase-space of our experiment, the GPD $H$, which encodes
the unpolarized density of partons, is
...
kinematic of the bound nucleon.
