...
%dominated by H? Do we have equivalents of eq. 3 for those? I actually did 
%notfind it in ref 31, which we are referring and we are also not using the 
%same definition of Im(H)...}
