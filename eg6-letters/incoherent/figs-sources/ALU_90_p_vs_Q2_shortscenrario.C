...
//=========  (Thu Jul  6 14:04:33 2017) by ROOT version6.09/01
   TCanvas *Can_p_Q2 = new TCanvas("Can_p_Q2", "DVCS Helium BoNuS",0,0,600,450);
   gStyle->SetOptFit(1);
   ...
   TH1F *Graph_Graph1001 = new TH1F("Graph_Graph1001","Graph",100,1.2253,3.2617);
   Graph_Graph1001->SetMinimum(0.07522398);
   Graph_Graph1001->SetMaximum(0.2333798);
