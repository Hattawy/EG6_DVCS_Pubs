...
\item    For figure 6, you state that "our experiment shows a sharp drop" (line 
   250), in the incoherent $A_{LU}$/proton $A_{LU}$. You do indeed have a 
      ...
      \textcolor{blue}{The text is updated.}
...
\item    To further consider this statement, I looked up ref. 21, which 
   ...
   \textcolor{blue}{For this specific purpose, we applied four dimensional 
      ...
      \textcolor{red}{Figure provided are not corresponding. Moreover, we talk 
      about extrapolating free proton data in the paper. Yet, it appears 
      that we are rather rebinning the eg6 data. We should update figures
      (including in the analysis note) and rephrase the statement in the 
      paper.}
...
\item  The paper makes no mention of the initial momentum of the struck 
   ...
   \textcolor{red}{Please Mohammad check what I added in the paper on this topic.} 
